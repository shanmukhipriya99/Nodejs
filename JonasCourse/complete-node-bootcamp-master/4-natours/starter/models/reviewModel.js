...
reviewSchema.statics.calcAverageRatings = async function (tourId) {
  ...
  // using static method as aggregate() can be called on a model
...
reviewSchema.pre(/^findOneAnd/, async function (next) {
  // this is a query document and so we don't have direct access to the doc
  // following is a work-around
  // 'r' contains the doc that we want to access
