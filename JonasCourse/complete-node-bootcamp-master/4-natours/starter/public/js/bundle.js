...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hhbm11a2hpZCIsImEiOiJjbGZyaDVycXAwNjc2M3JtaTVwb3VwNXVtIn0.dnUNBDyUzGbO4QmJYqSJ2g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/shanmukhid/clfrias8w002301qiyr9ix4ot',
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', _context3.t0.data.response.message);
        case 10:
        case "end":
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MssygL6wjTdPSgP1dUSPUhbLsGku5t6pKwvpR3rSUh744AFZlV5jrPxkDmehjtUvFUIOXsfpjohVUL77DzhNw3k00oXdAj3Pw');
          _context.prev = 1;
          _context.next = 4;
